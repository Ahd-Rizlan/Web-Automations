...
public class FDDetailViewTest extends BaseTest {
    ...
    @Test(priority = 2, dataProvider = "FDDetailView", description = "Obtain loan that in quick action section and validating the loan creation confirmation - 119,121,122,123,124,125,126,", dataProviderClass = DataProviders.FDDetailsveiwDataProvider.class)
