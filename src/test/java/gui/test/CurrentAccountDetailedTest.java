...
public class CurrentAccountDetailedTest extends BaseTest {
    ...
    public void validateCAChequeRequestFields(String accountNumber) throws InterruptedException {
        dashboardPage.navigateToMainMenu(BillerConstants.BUTTON_MY_ACCOUNTS);
        myAccountsPage.ValidateChequeRequestDetails(MyAccountsConstants.TAB_NAMES[0], MyAccountsConstants.TILE_HEADERS[0], accountNumber, Arrays.asList(MyAccountsConstants.CHECKBOOK_LEAFS), Arrays.asList(MyAccountsConstants.CHECKBOOK_COUNT));
    }

    @Test(priority = 4, dataProvider = "AdvancedSearchData", description = "Validate that transaction Filter  | 2,3", dataProviderClass = DataProviders.MyAccountPageDataProvider.class)
    public void validateCAFilter(String accountNumber, String month, String year, String from, String to, String fullDate, String amountFrom, String amountTo) throws InterruptedException {
        dashboardPage.navigateToMainMenu(BillerConstants.BUTTON_MY_ACCOUNTS);
        myAccountsPage.ValidateAdvancedSearch(MyAccountsConstants.TAB_NAMES[0], MyAccountsConstants.TILE_HEADERS[0], accountNumber, month, year, from, to, fullDate, amountFrom, amountTo);
