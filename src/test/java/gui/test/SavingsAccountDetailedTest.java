...
public class SavingsAccountDetailedTest extends BaseTest {
    ...
    @Test(priority = 2, dataProvider = "SavingsAccountData", description = "Validate that the customer able to view summary of savings account and the advanced search PDF view | 1,2,3 Upliftment | U2,U3,U4,U5,U6", dataProviderClass = DataProviders.MyAccountPageDataProvider.class)
    public void validateSADetails(String accountNumber, String accHolderName, String systemReserved, String lienAmount, String accOpenedOn, String accountBalance, String floatBalance, String amountFrom, String amountTo, String name, String address, String accountNo, String currency) throws InterruptedException {
        dashboardPage.navigateToMainMenu(BillerConstants.BUTTON_MY_ACCOUNTS);
        myAccountsPage.ValidateSavingsAccountDetails(MyAccountsConstants.TAB_NAMES[0], MyAccountsConstants.TILE_HEADERS[0], accountNumber, accHolderName, systemReserved, lienAmount, accOpenedOn, accountBalance, floatBalance, amountFrom, amountTo, dowloadLocation, name, address, accountNo, currency);
    }
