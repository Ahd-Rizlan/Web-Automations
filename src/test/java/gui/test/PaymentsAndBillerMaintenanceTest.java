...
//        dashboardPage.closeAlertPopup();
    ...
    public void validateSavedBillerFilterOptions() {
        ...
        billPaymentPage.validateReinitiationOfTransactionFromHistory(BillerConstants.CONSTANTS_MAP.get("KW_NATIONAL_WATER_SUPPLY_AND_DRAINAGE_BOARD"), BillerConstants.OTP, BillerConstants.CONSTANTS_MAP.get("KW_AMOUNT"), BillerConstants.CONSTANTS_MAP.get("KW_YOUR_GSM_PHONE_NUMBER"));
    }
