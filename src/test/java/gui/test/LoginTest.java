...
public class LoginTest extends BaseTest {
    ...
    @Test(priority = 3, dataProvider = "LoginData", description = "Validate the successful logging with correct user ID & Password", dataProviderClass = DataProviders.LoginDataProvider.class)
    ...
    @Test(priority = 4, dataProvider = "LoginData", description = "Browser back and forward functions", dataProviderClass = DataProviders.LoginDataProvider.class)
    ...
    @Test(priority = 5, dataProvider = "InvalidPassword", description = "Validate the logging with correct user ID & invalid password.", dataProviderClass = DataProviders.LoginDataProvider.class)
    ...
    @Test(priority = 6, dataProvider = "LogoutData", description = "Validate the successful logout", dataProviderClass = DataProviders.LoginDataProvider.class)
    ...
    @Test(priority = 8, dataProvider = "InvalidUserId", description = "Validate the invalid user ID for forget password journey", dataProviderClass = DataProviders.LoginDataProvider.class)
...
//    }
    @Test(priority = 1, dataProvider = "LockedUser", description = "Validate the unsuccessful login with locked user ID", dataProviderClass = DataProviders.LoginDataProvider.class)
