...
public class OldVishwaInquiriesTest extends BaseTest {
    ...
    @Test(dataProvider = "LoginDataAlternateSix", description = "Pre-Requisite :: Login to the Sampath vishwa application as alternate user two", dataProviderClass = DataProviders.LoginDataProvider.class)
    ...
    @Test(description = "Old vishwa inquiries| 1,2")
    ...
    @Test(dataProvider = "InboxMessagesData", description = "Old vishwa inquiries| 3", dataProviderClass = DataProviders.OldVishwaInquiryDataProvider.class)
    ...
    @Test(description = "Old vishwa inquiries| 12")
    ...
    @Test(description = "Old vishwa inquiries| 13")
    ...
    @Test(dataProvider = "LoginDataAlternateThirteen", description = "Pre-Requisite :: Login to the Sampath vishwa application as alternate user thirteen", dataProviderClass = DataProviders.LoginDataProvider.class)
    public void logIntoDahsboardAlternateUserThirteen(String userName, String password, String emailSentSuccessMsg) throws InterruptedException {
