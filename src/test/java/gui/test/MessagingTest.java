...
public class MessagingTest extends BaseTest {
    ...
    public void validateInboxAndRestoreMessages(String subject,String successMsg, String otp,String messageCreationSuccessMsg,String message,String responseMsg,String messageDeletionSuccessMsg,String messageRecoverySuccessMsg,String headerTile,String userName,String password,String filePath,String importantMsg) throws InterruptedException {

        dashboardPage.navigateToMessages();
        //prerequisite of message
        message=message+" "+randomAlphaNumeric(5);
        messagesPage.validateImportantMsg(importantMsg);
        messagesPage.FundTransferDisputeValidations(subject,successMsg,otp,messageCreationSuccessMsg, message,filePath);
        dashboardPage.captureBaseWindowHandle();
        //Sent mail admin validation
        vishwaRetailAdminLoginPage.navigateToTab(1);
