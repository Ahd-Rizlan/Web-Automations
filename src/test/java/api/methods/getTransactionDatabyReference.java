...
public class getTransactionDatabyReference extends baseMethod {
    private static final String pageNo = "pageNo";
    private static final String transactionId = "tranId";
    ...
    private static final String JSON_PATH = USER_DIR + GET_TRANSACTION_DATA_BY_REFERENCE_RESPONSE;
    ...
    public void invokeGetTransactionDataByReferenceApi() {
        setHeaders();
        response = RestAssured.given()
                .relaxedHTTPSValidation()
                .baseUri(baseHost)
                .headers(headersMap)
                .basePath(GET_TRANSACTION_DATA_BY_REFERENCE_PATH)
                .queryParam(transactionId, transactionIdValue)
                .when()
                .log()
                .all()
                .get();
