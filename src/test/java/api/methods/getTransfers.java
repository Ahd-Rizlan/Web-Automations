...
public class getTransfers extends baseMethod {
    ...
    private static final String JSON_PATH = USER_DIR + GET_TRANSFERS_RESPONSE;
    private static final String POST_BODY = USER_DIR + GET_TRANSFERS_BODY;
    ...
    public void invokeGetTransfersApi() {
        setHeaders();
        RestAssured.useRelaxedHTTPSValidation();
        response = RestAssured.given()
                .baseUri(baseHost)
                .headers(headersMap)
                .basePath(GET_TRANSFERS_PATH)
                .body(jsonBody)
                .when()
                .log()
                .all()
