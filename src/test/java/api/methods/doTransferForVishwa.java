...
public class doTransferForVishwa extends baseMethod {
    ...
    private static final String JSON_PATH = USER_DIR + DO_TRANSFER_FOR_VISHWA_RESPONSE;
    private static final String POST_BODY = USER_DIR + DO_TRANSFER_FOR_VISHWA_BODY;
    ...
    public void setHeaders() {
        ...
        headersMap.put(TXT_X_REQUEST_ID, TXT_X_REQUEST_ID_VALUE_ONE_TO_SIX);
    }


    public void invokeDoTransferForVishwaApi() {
        setHeaders();
        RestAssured.useRelaxedHTTPSValidation();
        response = RestAssured.given()
                .baseUri(baseHost)
                .headers(headersMap)
                .basePath(GET_DO_TRANSFER_FOR_VISHVA_PATH)
                .body(jsonBody)
                .when()
                .log()
                .all()
    ...
    public void validatePayload() {
        new PayloadValidator().validateJsonFileWithExcludedDataFields(JSON_PATH,response,new String[]{"transferReference"});
    }
}
