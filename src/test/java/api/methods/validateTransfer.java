...
public class validateTransfer extends baseMethod {
    ...
    private static final String JSON_PATH = USER_DIR + GET_VALIDATE_TRANSFER_RESPONSE;
    private static final String POST_BODY = USER_DIR + GET_VALIDATE_TRANSFER_BODY;
    ...
    public void invokeValidateTransferApi() {
        setHeaders();
        RestAssured.useRelaxedHTTPSValidation();
        response = RestAssured.given()
                .baseUri(baseHost)
                .headers(headersMap)
                .basePath(GET_VALIDATE_TRANSFER_PATH)
                .body(jsonBody)
                .when()
                .log()
                .all()
