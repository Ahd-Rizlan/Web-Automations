...
public class updateFavouritePayee extends baseMethod {
    ...
    private static final String JSON_PATH = USER_DIR + GET_UPDATE_FAVOURITE_PAYEE_RESPONSE;
    private static final String POST_BODY = USER_DIR + GET_UPDATE_FAVOURITE_PAYEE_BODY;
    ...
    public void invokeUpdateFavouritePayeeApi() {
        setHeaders();
        RestAssured.useRelaxedHTTPSValidation();
        response = RestAssured.given()
                .baseUri(baseHost)
                .headers(headersMap)
                .basePath(GET_UPDATE_FAVOURITE_PAYEE_PATH)
                .body(jsonBody)
                .when()
                .log()
                .all()
