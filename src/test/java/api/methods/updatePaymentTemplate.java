...
public class updatePaymentTemplate extends baseMethod {
    ...
    private static final String JSON_PATH = USER_DIR + UPDATE_PAYMENT_TEMPLATE_RESPONSE;
    private static final String POST_BODY = USER_DIR + UPDATE_PAYMENT_TEMPLATE_BODY;
    ...
    public void invokeUpdatePaymentTemplate() {
        setHeaders();
        RestAssured.useRelaxedHTTPSValidation();
        response = RestAssured.given()
                .baseUri(baseHost)
                .headers(headersMap)
                .basePath(GET_UPDATE_PAYMENT_TEMPLATE_PATH)
                .body(jsonBody)
                .when()
                .log()
                .all()
