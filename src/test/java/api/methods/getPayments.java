...
public class getPayments extends baseMethod {
    ...
    private static final String JSON_PATH = USER_DIR + GET_PAYMENTS_RESPONSE;
    private static final String POST_BODY = USER_DIR + GET_PAYMENTS_BODY;
    ...
    public void invokeGetPaymentsApi() {
        setHeaders();
        RestAssured.useRelaxedHTTPSValidation();
        response = RestAssured.given()
                .baseUri(baseHost)
                .headers(headersMap)
                .basePath(GET_PAYMENTS_PATH)
                .body(jsonBody)
                .when()
                .log()
                .all()
