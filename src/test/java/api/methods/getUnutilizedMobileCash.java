...
public class getUnutilizedMobileCash extends baseMethod {
    ...
    private static final String JSON_PATH = USER_DIR + GET_UNUTILIZED_MOBILE_CACHE_RESPONSE;
    ...
    public void invokeGetUnutilizedMobileCashApi() {
        setHeaders();
        RestAssured.useRelaxedHTTPSValidation();
        response = RestAssured.given()
                .baseUri(baseHost)
                .headers(headersMap)
                .basePath(GET_UTILIZED_MOBILE_CACHE_PATH)
                .when()
                .log()
                .all()
                .post();
