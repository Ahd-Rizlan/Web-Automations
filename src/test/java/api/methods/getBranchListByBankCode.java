...
public class getBranchListByBankCode extends baseMethod {
    ...
    private static final String JSON_PATH = USER_DIR + GET_BRANCH_LIST_BY_BANK_CODE_RESPONSE;
    ...
    public void setHeaders() {
        ...
        headersMap.put(TXT_X_REQUEST_ID, TXT_X_REQUEST_ID_VALUE_ONE);
    }

    public void invokeGetBranchListByBankCodeApi() {
        setHeaders();
        response = RestAssured.given()
                .relaxedHTTPSValidation()
                .baseUri(baseHost)
                .headers(headersMap)
                .basePath(GET_BRANCH_LIST_BY_BANK_CODE_PATH)
                .when()
                .log()
                .all()
                .get();
