...
public class getAccountsByTrantype extends baseMethod {
    ...
    private static final String JSON_PATH = USER_DIR + GET_ACCOUNT_BY_TRAN_TYPE_RESPONSE;
    ...
    public void invokeGetAccountsByTrantypeApi() {
        setHeaders();
        response = RestAssured.given()
                .relaxedHTTPSValidation()
                .baseUri(baseHost)
                .headers(headersMap)
                .basePath(GET_ACCOUNTS_BY_TRAN_TYPE_PATH)
                .when()
                .log()
                .all()
                .get();
