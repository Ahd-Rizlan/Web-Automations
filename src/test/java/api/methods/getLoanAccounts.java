...
public class getLoanAccounts extends baseMethod {
    ...
    private static final String JSON_PATH = USER_DIR + GET_LOAN_ACCOUNTS_RESPONSE;
    ...
    public void invokeGetLoanAccountsApi() {
        setHeaders();
        response = RestAssured.given()
                .relaxedHTTPSValidation()
                .baseUri(baseHost)
                .headers(headersMap)
                .basePath(GET_LOAN_ACCOUNT_PATH)
