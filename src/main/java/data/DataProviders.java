...
public class DataProviders {
    ...
    public static class LoginDataProvider {
        ...
        @DataProvider(name = "InvalidSecurityAnswer")
        public static Iterator<Object[]> getIncorrectSecurityData() {
            String[] columnNames = {"userName","successMsg","invalidMsg"};
        ...
        public static Iterator<Object[]> getPasswordRetryData() {
            String[] columnNames = {"passwords", "errorMsg", "userName", "emailSentSuccessMsg"};
            return XlsReader.getDataFromSheet(filePath, "PasswordTestData", columnNames).iterator();
        }

        @DataProvider(name = "PasswordReset")
        public static Iterator<Object[]> validateResetData() {
            String[] columnNames = {"userName", "passwordLessThatEightCharacters", "passwordRepeatedCharacters", "passwordNoUppercaseCharacters", "passwordNoLowercaseCharacters", "passwordNonumber", "passwordNoSpecialCharater","successMsg"};
            return XlsReader.getDataFromSheet(filePath, "PasswordReset", columnNames).iterator();
        }
        @DataProvider(name = "LoginDataAlternateTen")
        public static Iterator<Object[]> getLoginDataAlternateTen() {
            String[] columnNames = {"userName", "password" ,"emailSentSuccessMsg"};
            return XlsReader.getDataFromSheet(filePath, "LoginDataAlternateTen", columnNames).iterator();
        }
        @DataProvider(name = "LoginDataAlternateEleven")
        public static Iterator<Object[]> getLoginDataAlternateEleven() {
            String[] columnNames = {"userName", "password" ,"emailSentSuccessMsg"};
            return XlsReader.getDataFromSheet(filePath, "LoginDataAlternateEleven", columnNames).iterator();
        }

        @DataProvider(name = "SignUpData")
        public static Iterator<Object[]> getSignUpURL() {
            String[] columnNames = {"expectedPart"};
            return XlsReader.getDataFromSheet(filePath, "SignUpData", columnNames).iterator();
        }
        @DataProvider(name = "LoginDataAlternateTwelve")
        public static Iterator<Object[]> getLoginDataAlternateTwelve() {
            String[] columnNames = {"userName", "password" ,"emailSentSuccessMsg"};
            return XlsReader.getDataFromSheet(filePath, "LoginDataAlternateTwelve", columnNames).iterator();
        }
        @DataProvider(name = "LoginDataAlternateThirteen")
        public static Iterator<Object[]> getLoginDataAlternateThirteen() {
            String[] columnNames = {"userName", "password" ,"emailSentSuccessMsg"};
            return XlsReader.getDataFromSheet(filePath, "LoginDataAlternateThirteen", columnNames).iterator();
        }
        @DataProvider(name = "LoginDataAlternateFourteen")
        public static Iterator<Object[]> getLoginDataAlternateFourteen() {
            String[] columnNames = {"userName", "password" ,"emailSentSuccessMsg"};
            return XlsReader.getDataFromSheet(filePath, "LoginDataAlternateFourteen", columnNames).iterator();
        }
    ...
    public static class SettingsPageDataProvider {
        ...
        public static Iterator<Object[]> getLoginDataAfterthePasswordChagne() {
            String[] columnNames = {"userName", "password", "newPassword", "LoginErrorMessage", "emailSentSuccessMsg","passwordForRevertTwo", "passwordForRevertThree"};
    ...
    public static class SavingsandFDDataProvider {
        ...
        @DataProvider(name = "SavingValidationOneRun")
        public static Object[][] getSavingValidationOneRun() {
            List<Object[]> rawData = XlsReader.getDataFromSheet(filePath, "SavingAccountValidationData",
                    new String[]{"invalidAmount", "validAmount", "expectedError", "successMsg"});

            return new Object[][]{{rawData}};
        }
        @DataProvider(name = "FDAccountValidationData")
        public static Object[][] getFDValidationOneRun() {
            List<Object[]> rawData = XlsReader.getDataFromSheet(filePath, "FDAccountValidationData",
                    new String[]{"invalidAmount","month","rate", "expectedError"});
    ...
    public static class TransfersPageDataProvider {
        ...
        @DataProvider(name = "OwnBankTransactions")
        public static Iterator<Object[]> getOwnBankTransfersData() {
            String[] columnNames = {
                    ...
                    "bankName","bankNameTwo", "actualTransactionAmount"
            };
            return XlsReader.getDataFromSheet(filePath, "OwnBankTransactions", columnNames).iterator();
        }
        ...
        public static Iterator<Object[]> getOtherAccountTransfersData() {
            String[] columnNames = {
                    ...
                    "minAmountMsg", "maxAmountMsg", "toAccount", "amount",
                    "transferMode", "receiverName", "purpose",
                    "bankName","branch", "actualTransactionAmount"
            };
        ...
        @DataProvider(name = "MobileCashTransferData")
        public static Iterator<Object[]> getMobileCashData() {
            String[] columnNames = {
                    "errNICNumberRequired",
                    "errMobileNumberRequired",
                    "errReEnterMobileNumberRequired",
                    "errNameRequired",
                    "errAmountRequired",
                    "errPurposeRequired",
                    "errBeneficiaryRemarkRequired",
                    "errorMessageMultipleOfHundred",
                    "nicNumber",
                    "mobileNo",
                    "name",
                    "purpose",
                    "errorMessageMaxTransactionLimit",
                    "amount",
                    "minAmount",
                    "errInsufficientfunds",
                    "errMinimumTransferAmount",
                    "maxAmountInHundred"
            };
            return XlsReader.getDataFromSheet(filePath, "MobileCashData", columnNames).iterator();
        }

        @DataProvider(name = "StaffAccountTransfersData")
        public static Iterator<Object[]> getStaffAccountTransfersData() {
            String[] columnNames = {
                    "errorMsg","toAccount",
                    "amount","transferMode",
                    "receiverName","purpose",
                    "bankName"
            };
            return XlsReader.getDataFromSheet(filePath, "StaffAccountTransfersData", columnNames).iterator();
        }
    ...
    public static class MessagesPageDataProvider {
        ...
        public static Iterator<Object[]> getInboxAndRestoreMessagesValidationData() {
            String[] columnNames = { "subject", "successMsg", "otp", "messageCreationSuccessMsg", "message", "responseMsg", "messageDeletionSuccessMsg", "messageRecoverySuccessMsg", "headerTile", "userName", "password","filePath","importantMsg"
            };
    ...
    public static class MyAccountPageDataProvider {
        ...
        public static Iterator<Object[]> getSavingsAccountData() {
            String[] columnNames = {"accountNumber", "accHolderName",
                    ...
                    "floatBalance", "amountFrom", "amountTo","name",	"address",	"accountNo",	"currency"
            };
        ...
        public static Iterator<Object[]> getChequeRequestData() {
            String[] columnNames = {"accountNumber", "contactNo","branch", "successMsg"};
        ...
        public static Iterator<Object[]> getAdvancedSearchData() {
            String[] columnNames = {
                    "accountNumber", "month", "year",
                        "from", "to", "fullDate", "amountFrom", "amountTo", "name", "address", "accountNo", "currency"
            };
            return XlsReader.getDataFromSheet(filePath, "AdvancedSearchData", columnNames).iterator();
        }

        @DataProvider(name = "StopAndRevokeChequeData")
        public static Iterator<Object[]> getStopAndRevokeChequeData() {
            String[] columnNames = {
                    "accountNumber",
                    "chequeBookNo",
                    "stopChequeMsg",
                    "proceedingMsg",
                    "reason",
                    "stopChequeSuccessMsg"
            };
            return XlsReader.getDataFromSheet(filePath, "StopAndRevokeChequeData", columnNames).iterator();
        }
    ...
    public static class AcknowledgementMessagesDataProvider {
        ...
        public static Iterator<Object[]> getAcknowledgementMessagesData() {
            String[] columnNames = {
                    ...
                    "mobileNo", "ackMsg","paymentProcessingFeeMsg"
            };
            return XlsReader.getDataFromSheet(filePath, "AcknowledgementMessages", columnNames).iterator();
        }
        @DataProvider(name = "AcknowledgementOwnAccountTransferData")
        public static Iterator<Object[]> getOwnAccountTransferData() {
            String[] columnNames = {
                    "errorMsg1", "errorMsg2", "minAmount", "maxAmount", "minAmountMsg",
                    "maxAmountMsg", "toAccount", "amount", "transferMode","noAmount","errMinimumTransferAmount","fromAccount"
            };
            return XlsReader.getDataFromSheet(filePath, "OwnAccountTransferFCData", columnNames).iterator();
        }
    }
    ...
    public static class CreditCardDetailViewDataProvider {
        ...
        public static Iterator<Object[]> getLoanDetailsView() {
            String[] columnNames = {
                    "payingAccountNumberUSD",
                    "payingAccountNumber",
                    "InsufficientamountErrUSD",
                    ...
                    "paymentAmountUSD",
                    "paymentAmount",
                    "acknowlagmentmessage",
                    "successMsg",
                    "successMsgForBlocking",
                    "emailSentSuccessMsg"};
    ...
    public static class WebCardDetailViewDataProvider {

        private static final String filePath;

        static {
            String projectRoot = System.getProperty("user.dir");
            filePath = projectRoot + "/" + property.getProperty("gui-config", "TESTDATA_PATH")+ DataSheetNameConstants.WEBCARDDETAIL_VIEW +DataSheetNameConstants.SHEET_TYPE_XLSX;
        }

        @DataProvider(name = "WebCardDetailViewData")
        public static Iterator<Object[]> getLoanDetailsView() {
            String[] columnNames = {"payingAccountNumberUSD","paymentAmountUSD","payingAccountNumber","paymentAmount","successMsg","acknowlagmentmessage","successMsgPayment","successMsgCCV"};
            return XlsReader.getDataFromSheet(filePath, "WebCardDetailViewData", columnNames).iterator();
        }
        @DataProvider(name = "WebCardBlockData")
        public static Iterator<Object[]> getWebCardBlockData() {
            String[] columnNames = {"successMsgForBlocking","emailSentSuccessMsg"};
            return XlsReader.getDataFromSheet(filePath, "WebCardBlockData", columnNames).iterator();
        }
        @DataProvider(name = "WebCardInfoData")
        public static Iterator<Object[]> getWebCardInfoData() {
            String[] columnNames = {"residenceLable","expectedInfoRaw"};
            return XlsReader.getDataFromSheet(filePath, "WebCardInfoData", columnNames).iterator();
        }
