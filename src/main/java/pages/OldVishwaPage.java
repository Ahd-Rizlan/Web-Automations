...
public class OldVishwaPage extends BasePage {
    ...
    /**
     * Navigates to the old Vishwa mail interface and validates that an email with the specified subject exists in the inbox
     *
     * @param subject the subject of the email to validate in the inbox
     */
