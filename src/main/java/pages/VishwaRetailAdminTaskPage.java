...
//        selectTaskHeader(AdminTaskConstants.INBOX);
    ...
    public void forwardMailAndValidate(String subject,String branch,String message,String user) {
        ...
        //Adding short wait as the certain dropdown values does not load
        waitFor(SHORT_WAIT);
    ...
    public void validateFundTransferRequest(String subject,String message){
        addToReport("----------Start of validation of fund transfer request are available in admin----------", Status.PASS, true);
